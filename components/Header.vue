<!-- Start of My Component Header -->
<template>
  <!-- Menu of the System -->
<nav class="bg-blue-600">
  <div class=" mx-auto px-2 sm:px-6 md:px-6 lg:px-8">
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-8 w-auto" src="/logo/logo.png" alt="Workflow" />
          <img class="hidden lg:block h-8 w-auto" src="/logo/logo.png" alt="Workflow" />
        </div>
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4">
            ...
            <nuxt-link :to="{name: 'register'}" v-show="!$auth.loggedIn" exact class=" text-white px-3 py-2 rounded-md text-sm font-medium">Registar </nuxt-link>

            <nuxt-link :to="{name: 'login'}"  v-show="!$auth.loggedIn"  exact class=" text-white px-3 py-2 rounded-md text-sm font-medium">Login </nuxt-link>
  ...
  <div v-show="mobile" class="sm:hidden" id="mobile-menu">
